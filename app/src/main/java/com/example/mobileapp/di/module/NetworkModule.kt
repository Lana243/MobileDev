...
import com.example.mobileapp.data.network.interceptor.MobileAppAuthenticator
import com.example.mobileapp.data.network.interceptor.UserAgentInterceptor
    ...
    fun provideOkhttpClient(authRepository: AuthRepository): OkHttpClient =
        OkHttpClient.Builder()
            .apply {
                ...
                authenticator(MobileAppAuthenticator(authRepository))
