...
import com.example.mobileapp.util.dpToPx
import com.example.mobileapp.util.getCompatColor
import com.example.mobileapp.util.inflate
...
class PostLikesView @JvmOverloads constructor(
    ...
    private var circleBorderPaint: Paint =
        Paint()
            .apply {
                color = context.getCompatColor(R.color.brand_blue)
